...
export function DitheringShader({
  ...
  useEffect(() => {
    ...
    const render = () => {
      ...
      if (locs.u_resolution) context.uniform2f(locs.u_resolution, width, height)
      if (locs.u_colorBack) context.uniform4fv(locs.u_colorBack, hexToRgba(colorBack))
      if (locs.u_colorFront) context.uniform4fv(locs.u_colorFront, hexToRgba(colorFront))
      ...
      if (locs.u_pxSize) context.uniform1f(locs.u_pxSize, pxSize)
